...
required=(
  ...
  "validate_v81_api_candidate_safe.py"
...
echo
echo "[4/4] Run V8.1 candidate API integration smoke with explicit runtime cleanup..."
mkdir -p logs
python validate_v81_api_candidate_safe.py 2>&1 | tee logs/v81_api_candidate_validation.log
