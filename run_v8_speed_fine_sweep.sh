...
API_PORT=8810
CALLBACK_PORT=8899
OUT="$ROOT/artifacts/v8_speed_fine"
mkdir -p "$OUT"
...
echo "======================================================================"
echo "V8-SPEED FINE SWEEP AROUND BEST CONFIG"
echo "======================================================================"
...
CONFIGS=(
  ...
  "G_6x2_gap025|6|2|0.25"
  "H_6x2_gap005|6|2|0.05"
  "I_7x2_gap010|7|2|0.10"
  "J_5x3_gap010|5|3|0.10"
  "K_6x1_gap010|6|1|0.10"
)
